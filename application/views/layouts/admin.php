...
<html lang="en">
    <head>
        ...
        <link href="/public/styles/bootstrap-tokenfield.min.css" rel="stylesheet">
        ...
        <script src="/public/scripts/bootstrap-tokenfield.min.js"></script>
    </head>
            ...
            <footer class="sticky-footer">
                <div class="container">
                    <div class="text-center">
                        <small>&copy; 2019, ссылка, на используемый <a href="https://startbootstrap.com/templates/sb-admin/">шаблон</a> для панели администратора</small>
                    </div>
                </div>
            </footer>
        <?php endif; ?>
